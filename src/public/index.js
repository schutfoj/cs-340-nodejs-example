...
function handleCreateTwitFormSubmit(e) {
   ...
   */
  if (!twitText || twitText === '' || !twitAuthor || twitAuthor === '') {
...
window.addEventListener('DOMContentLoaded', function() {
  ...
  var formCreateTwit = document.getElementById('form-create-twit');
  if (formCreateTwit) {
    formCreateTwit.addEventListener('submit', handleCreateTwitFormSubmit);
  }
